...
#Hint 10: If the game has not ended, ask the user if 
# they want to draw another card. 
# If yes, then use the deal_card() function to 
# add another card to the user_cards List. If no, then the 
# game has ended.

#Hint 11: The score will need to be rechecked with 
# every new card drawn and the checks in 
# Hint 9 need to be repeated until the game ends.

#Hint 12: Once the user is done, it's time to let the computer 
# play. 
# The computer should keep drawing cards as long as it 
...
while not is_game_over:
    ...
    if user_score == 0 or computer_score == 0 or user_score > 21:
        ...
        if user_should_deal == "y": user_cards.append(deal_card())
        else:
            is_game_over = True
...
# and start a new game of blackjack and show 
# the logo from art.py.

while input("Do you want to play a game of Blackjack? Type 'Yes' or 'No': ") == "y":
    clear()
    play_game()
